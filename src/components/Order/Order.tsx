...
export const Order = () => {
    ...
    return (
        ...
        />
        <Button variant='contained' color='success' onClick={()=>{setOpen(true)}}>Update</Button>
        <Button variant='contained' color='error' onClick={deleteItem} sx={{marginLeft: '10px'}}>Delete</Button>
